...
#teacherCheck = "Deploying a model into a Big Data Platform involves mainly three key steps they are,Data ingestion Data Storage Data Processing"
#studenCheck = "ANSWER: starsdeploying a model into a big data platform involves mainly three key steps they are data injection data storage data processing"
#checkparaSimilarity(studenCheck,studenCheck)
